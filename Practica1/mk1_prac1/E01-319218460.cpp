...
void CrearFiguras()
{
	...
	for (int i = 0; i < 2; i++) {
		...
		glBufferData(GL_ARRAY_BUFFER, tamanos[i], figuras[i], GL_STATIC_DRAW);//pasarle los datos al VBO asignando tamano, los datos y en este caso es estático pues no se modificarán los valores
