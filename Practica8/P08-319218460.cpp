...
int main()
{
	...
	spotLights[3] = SpotLight(0.5f, 0.5f, 0.0f, //Color
		1.0f, 2.5f,                             //ambient, diffuse intensity
		0.0f, 1.7f, 3.0f,					 //posición	inicial 														
		0.0f, -1.0f, 0.0f,                  //dirección
		1.0f, 0.0f, 0.0f,                   //atenuación
		25.0f);                            //ángulo de luz (borde del cono)
	spotLightCount++;
	...
	spotLights[5] = SpotLight(1.0f, 0.0f, 0.0f, //Color
		1.0f, 2.5f,                             //ambient, diffuse intensity
		1.9f, 1.7f, -6.0f,					 //posición	inicial 														
		0.0f, 0.0f, -1.0f,                  //dirección
		1.0f, 0.0f, 0.0f,                   //atenuación
		12.0f);                            //ángulo de luz (borde del cono)
	spotLightCount++;
	...
	pointLights[2] = PointLight(1.0f, 1.0f, 1.0f, //Color
		...
		-10.0f, 0.7f, 6.0,					 //posición	inicial 														
		0.6f, 0.2f, 0.1f);                   //atenuación                           //ángulo de luz (borde del cono)
	pointLightCount++;
